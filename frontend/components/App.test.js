...
describe("Module 4 Project Tests", () => {
  describe("English Language", () => {
    ...
    */
    ...
    //   render(<App lang="en" />);
    //   expect(
    //     screen.getByText(txt.en.TEXT_HEADING_CREATE_ACCOUNT)
    //   ).toBeVisible();
    // });
    // // by label text
    ...
    //   render(<App lang="en" />);
    //   expect(
    //     screen.getByPlaceholderText(txt.en.PLACEHOLDER_USERNAME)
    //   ).toBeVisible();
    // });
  });
  describe("Spanish Language", () => {
    ...
    */
    ...
    //   render(<App lang="esp" />);
    //   expect(
    //     screen.getByText(txt.esp.TEXT_HEADING_CREATE_ACCOUNT)
    //   ).toBeVisible();
    // });
    // // by label text
    // test(`LABEL_USERNAME is visible`, () => {
    ...
    //   render(<App lang="esp" />);
    //   expect(
    //     screen.getByPlaceholderText(txt.esp.PLACEHOLDER_USERNAME)
    //   ).toBeVisible();
    // });
  });
